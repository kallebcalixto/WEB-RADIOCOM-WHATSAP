...
<title><?php echo $page_title; ?> - Contato</title>
                ...
                <div class="navigation">
                  ...
                  <div id="smoothmenu1" class="ddsmoothmenu">
                            ...
                            <ul>
                                ...
                                <li class="current-menu-item"><a href="contato">Contato</a></li>
...
<br />
                        	<?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/includes/form.php"); ?>
                            <?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/data/blocks/paginas/contato.html"); ?>
                            <div class="clear"></div>
                        </div>
                    </div>
                    <!-- Blog Post End -->
