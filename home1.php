...
<meta name="keywords" content="<?php echo $page_tagg; ?>"/>
    	...
    	<div id="header">
            ...
            <div class="container">
            	...
            	<div class="five columns left">
                	...
                	<a href="home.php" class="logo"><img src="<?php echo $logo_url; ?>" width="160" height="auto" alt="<?php echo $page_title; ?>" /></a> 
...
<?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/data/blocks/video-destaque.html"); ?>
</div>
...
<!-- videos List End -->
                                ...
                                <div id="tab-fotos" class="tab-list"> 
                                	...
                                	<!-- Gallery Small Section Start --><?php $gallery ="Foto-destaque"; include($_SERVER["DOCUMENT_ROOT"]."/admin/includes/gallery2.php"); ?>
...
<!-- banner Ouvinte do mês -->
        ...
        <div class="box-small1">
            <hr>
                    	<h1 class="heading1">Ouvinte do mês</h1>
                        <div class="box-in1">        
                <img src="<?php echo $logo_url2; ?>" width="100%" height="280px" alt="<?php echo $page_title; ?>" />
                        </div>
        </div>                
 ...
 <!-- banner Ouvinte do mês -->
                ...
                <div class="one-third column left">
                	<div class="box-small">
                    	<h1 class="heading">As Mais Tocadas</h1>
                        <div class="box-in">
                        	<?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/data/blocks/top-5.html"); ?>
                            <div class="clear"></div>
                        </div>
                	...
                	<div class="box-small">
                        ...
                        <div class="box-in">
                            ...
                            <div class="blog-pagination"><a href="blog">Mais Notícias</a></div>
                            <div class="clear"></div>
                        </div>
