...
<title><?php echo $page_title; ?> - Programação</title>
                ...
                <div class="navigation">
                  ...
                  <div id="smoothmenu1" class="ddsmoothmenu">
                            ...
                            <ul>
                                ...
                                <li class="current-menu-item"><a href="programacao">Programação</a></li>
        ...
        <div class="inner shadow">
            ...
            <div class="container row">
            	<div class="sixteen columns left">
                	<h1 class="heading">Programação</h1>
                    <!-- Static Page Start -->
                    <div class="in-sec nopad-bot">
                    	<div class="static">
                        <?php include_once($_SERVER["DOCUMENT_ROOT"]."/admin/data/blocks/paginas/programacao.html"); ?>
                        </div>
